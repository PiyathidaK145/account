          ...
          if (provider.transactions.isEmpty) {
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return Dismissible(
                  key: Key(statement.keyID.toString()), // Convert to String, // กำหนด key ให้กับ Dismissible
                  direction: DismissDirection.startToEnd, // เลื่อนจากซ้ายไปขวา
                  background: Container(
                    color: Colors.red, // สีพื้นหลังเมื่อเลื่อน
                    alignment: Alignment.centerLeft,
                    padding: const EdgeInsets.symmetric(horizontal: 20),
                    child: const Icon(Icons.delete, color: Colors.white), // ไอคอนลบ
                  ),
                  ...
                  onDismissed: (direction) {
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(content: Text('${statement.title} ถูกลบแล้ว')), // ข้อความฟีดแบ็ค
                    );
                  },
                  child: Card(
                    elevation: 5,
                    ...
                    child: ListTile(
                      ...
                      subtitle: Column(
                        ...
                        children: [
                          ...
                          Text('Date: ${DateFormat('dd MMM yyyy hh:mm:ss').format(statement.date)}'), // แสดงวันที่
                          Text('Contact: ${statement.contact}'), // แสดงข้อมูลติดต่อ
                          Text('Description: ${statement.description}'), // แสดงรายละเอียด
                      ...
                      trailing: CircleAvatar(
                        ...
                        backgroundImage: statement.image != null 
                          ? AssetImage(statement.image!) // ใช้ ! เพื่อยืนยันว่าไม่เป็น null
                          : null,
                        child: statement.image == null 
                          ? const Icon(Icons.image, size: 30) // ไอคอนแทนที่หากไม่มีภาพ
                          : null,
                      ),
                      onTap: () {
